...
<head>
    ...
    <style>
        ...
        /* Universal safety for SVGs to prevent browser explosions */
        svg {
            max-width: 100%;
            flex-shrink: 0;
        }
