...
<div class="space-y-8 max-w-6xl mx-auto pb-16">
    ...
    <!-- Navigation Tabs (Sleek Modern SaaS Tab Bar) -->
    <div class="bg-white/80 backdrop-blur-md p-1.5 rounded-2xl border border-slate-200/80 shadow-subtle flex flex-wrap gap-1.5 sticky top-24 z-30">
        <button type="button" onclick="switchSettingTab('branding')" id="btn-tab-branding" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-brand-600 text-white shadow-xs">
        ...
        <button type="button" onclick="switchSettingTab('security')" id="btn-tab-security" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
        ...
        <button type="button" onclick="switchSettingTab('contact')" id="btn-tab-contact" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
        ...
        <button type="button" onclick="switchSettingTab('media')" id="btn-tab-media" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
            ...
            <span>Video Bannerları</span>
        </button>

        <button type="button" onclick="switchSettingTab('stats')" id="btn-tab-stats" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
        ...
        <button type="button" onclick="switchSettingTab('social')" id="btn-tab-social" class="tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100">
...
function switchSettingTab(tabId) {
    ...
    tabs.forEach(t => {
        ...
        if (btn) {
            if (t === tabId) {
                btn.className = 'tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-brand-600 text-white shadow-xs';
            } else {
                btn.className = 'tab-btn px-4 py-2.5 text-xs font-bold rounded-xl transition-all flex items-center gap-2 text-slate-600 hover:text-slate-900 hover:bg-slate-100';
            }
        }
    });
